...
import { DatatypesManagement3Paths } from "./DatatypesManagement3";
...
> {
  ...
  isNewEntity = () => {
    return this.props.entityId === DatatypesManagement3Paths.NEW_SUBPATH;
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={DatatypesManagement3Paths.PATH} />;
    }
        ...
        >
          ...
          <Field
            ...
            parentEntityInstanceId={
              this.props.entityId !== DatatypesManagement3Paths.NEW_SUBPATH
                ? this.props.entityId
                : undefined
            }
            formItemProps={{
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={DatatypesManagement3Paths.PATH}>
