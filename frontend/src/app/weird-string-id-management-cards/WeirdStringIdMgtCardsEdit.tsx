...
import { WeirdStringIdMgtCardsManagementPaths } from "./WeirdStringIdMgtCardsManagement";
...
> {
  ...
  isNewEntity = () => {
    return (
      this.props.entityId === WeirdStringIdMgtCardsManagementPaths.NEW_SUBPATH
    );
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={WeirdStringIdMgtCardsManagementPaths.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        ...
        >
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={WeirdStringIdMgtCardsManagementPaths.PATH}>
