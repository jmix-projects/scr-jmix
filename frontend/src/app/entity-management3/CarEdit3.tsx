...
import { CarManagement3Paths } from "./CarManagement3";
...
class CarEdit3Component extends React.Component<Props & WrappedComponentProps> {
  ...
  isNewEntity = () => {
    return this.props.entityId === CarManagement3Paths.NEW_SUBPATH;
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={CarManagement3Paths.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        ...
        >
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={CarManagement3Paths.PATH}>
