...
import { DatatypesManagement1Paths } from "./DatatypesManagement1";
...
> {
  ...
  isNewEntity = () => {
    return this.props.entityId === DatatypesManagement1Paths.NEW_SUBPATH;
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={DatatypesManagement1Paths.PATH} />;
    }
        ...
        >
          ...
          <Field
            ...
            parentEntityInstanceId={
              this.props.entityId !== DatatypesManagement1Paths.NEW_SUBPATH
                ? this.props.entityId
                : undefined
            }
            formItemProps={{
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={DatatypesManagement1Paths.PATH}>
