...
import { IntIdentityIdMgtListManagementPaths } from "./IntIdentityIdMgtListManagement";
...
> {
  ...
  isNewEntity = () => {
    return (
      this.props.entityId === IntIdentityIdMgtListManagementPaths.NEW_SUBPATH
    );
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={IntIdentityIdMgtListManagementPaths.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        ...
        >
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={IntIdentityIdMgtListManagementPaths.PATH}>
