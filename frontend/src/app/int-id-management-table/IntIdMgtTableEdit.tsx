...
> {
  ...
  isNewEntity = () => {
    return this.props.entityId === IntIdManagementTablePaths.NEW_SUBPATH;
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={IntIdManagementTablePaths.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        ...
        >
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={IntIdManagementTablePaths.PATH}>
