...
import { BoringStringIdManagementTablePaths } from "./BoringStringIdManagementTable";
...
> {
  ...
  isNewEntity = () => {
    return (
      this.props.entityId === BoringStringIdManagementTablePaths.NEW_SUBPATH
    );
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={BoringStringIdManagementTablePaths.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        ...
        >
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={BoringStringIdManagementTablePaths.PATH}>
