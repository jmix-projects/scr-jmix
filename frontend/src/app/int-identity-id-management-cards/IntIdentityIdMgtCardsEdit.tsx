...
import { IntIdentityIdMgtCardsManagementPaths } from "./IntIdentityIdMgtCardsManagement";
...
> {
  ...
  isNewEntity = () => {
    return (
      this.props.entityId === IntIdentityIdMgtCardsManagementPaths.NEW_SUBPATH
    );
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={IntIdentityIdMgtCardsManagementPaths.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        ...
        >
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={IntIdentityIdMgtCardsManagementPaths.PATH}>
