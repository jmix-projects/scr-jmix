...
import { AssociationM2OManagementPaths } from "./AssociationM2OManagement";
...
> {
  ...
  isNewEntity = () => {
    return this.props.entityId === AssociationM2OManagementPaths.NEW_SUBPATH;
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={AssociationM2OManagementPaths.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        ...
        >
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={AssociationM2OManagementPaths.PATH}>
