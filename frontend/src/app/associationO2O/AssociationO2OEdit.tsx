...
import { AssociationO2OManagementPaths } from "./AssociationO2OManagement";
...
> {
  ...
  isNewEntity = () => {
    return this.props.entityId === AssociationO2OManagementPaths.NEW_SUBPATH;
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={AssociationO2OManagementPaths.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        ...
        >
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={AssociationO2OManagementPaths.PATH}>
