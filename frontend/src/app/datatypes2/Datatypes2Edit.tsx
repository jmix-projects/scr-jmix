...
> {
  ...
  isNewEntity = () => {
    return this.props.entityId === Datatypes2ManagementPaths.NEW_SUBPATH;
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={Datatypes2ManagementPaths.PATH} />;
    }
        ...
        >
          <Field
            ...
            parentEntityInstanceId={
              this.props.entityId !== Datatypes2ManagementPaths.NEW_SUBPATH
                ? this.props.entityId
                : undefined
            }
            formItemProps={{
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={Datatypes2ManagementPaths.PATH}>
