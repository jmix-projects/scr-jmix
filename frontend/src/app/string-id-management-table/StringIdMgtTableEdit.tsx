...
import { StringIdMgtTableManagementPaths } from "./StringIdMgtTableManagement";
...
> {
  ...
  isNewEntity = () => {
    return this.props.entityId === StringIdMgtTableManagementPaths.NEW_SUBPATH;
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={StringIdMgtTableManagementPaths.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        ...
        >
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={StringIdMgtTableManagementPaths.PATH}>
