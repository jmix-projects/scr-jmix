...
import { TrickyIdMgrPaths } from "./TrickyIdMgr";
...
> {
  ...
  isNewEntity = () => {
    return this.props.entityId === TrickyIdMgrPaths.NEW_SUBPATH;
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={TrickyIdMgrPaths.PATH} />;
    }
