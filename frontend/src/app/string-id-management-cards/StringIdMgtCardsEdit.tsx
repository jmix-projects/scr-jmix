...
import { StringIdMgtCardsManagementPaths } from "./StringIdMgtCardsManagement";
...
> {
  ...
  isNewEntity = () => {
    return this.props.entityId === StringIdMgtCardsManagementPaths.NEW_SUBPATH;
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={StringIdMgtCardsManagementPaths.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        ...
        >
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={StringIdMgtCardsManagementPaths.PATH}>
