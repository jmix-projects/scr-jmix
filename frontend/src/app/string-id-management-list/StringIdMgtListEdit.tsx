...
import { StringIdMgtListManagementPaths } from "./StringIdMgtListManagement";
...
> {
  ...
  isNewEntity = () => {
    return this.props.entityId === StringIdMgtListManagementPaths.NEW_SUBPATH;
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={StringIdMgtListManagementPaths.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        ...
        >
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={StringIdMgtListManagementPaths.PATH}>
