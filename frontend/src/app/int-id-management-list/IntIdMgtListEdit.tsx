...
import { IntIdManagementListPaths } from "./IntIdManagementList";
...
> {
  ...
  isNewEntity = () => {
    return this.props.entityId === IntIdManagementListPaths.NEW_SUBPATH;
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={IntIdManagementListPaths.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        ...
        >
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={IntIdManagementListPaths.PATH}>
