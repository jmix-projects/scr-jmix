...
import { IntIdentityIdMgtTableManagementPaths } from "./IntIdentityIdMgtTableManagement";
...
> {
  ...
  isNewEntity = () => {
    return (
      this.props.entityId === IntIdentityIdMgtTableManagementPaths.NEW_SUBPATH
    );
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={IntIdentityIdMgtTableManagementPaths.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        ...
        >
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={IntIdentityIdMgtTableManagementPaths.PATH}>
