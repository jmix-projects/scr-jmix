...
import { AssociationM2MManagementPaths } from "./AssociationM2MManagement";
...
> {
  ...
  isNewEntity = () => {
    return this.props.entityId === AssociationM2MManagementPaths.NEW_SUBPATH;
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={AssociationM2MManagementPaths.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        ...
        >
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={AssociationM2MManagementPaths.PATH}>
