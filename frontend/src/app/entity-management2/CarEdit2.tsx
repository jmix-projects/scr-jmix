...
import { CarManagement2Paths } from "./CarManagement2";
...
class CarEdit2Component extends React.Component<Props & WrappedComponentProps> {
  ...
  isNewEntity = () => {
    return this.props.entityId === CarManagement2Paths.NEW_SUBPATH;
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={CarManagement2Paths.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        ...
        >
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={CarManagement2Paths.PATH}>
