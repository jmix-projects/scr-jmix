...
import { WeirdStringIdMgtTableManagementPaths } from "./WeirdStringIdMgtTableManagement";
...
> {
  ...
  isNewEntity = () => {
    return (
      this.props.entityId === WeirdStringIdMgtTableManagementPaths.NEW_SUBPATH
    );
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={WeirdStringIdMgtTableManagementPaths.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        ...
        >
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={WeirdStringIdMgtTableManagementPaths.PATH}>
