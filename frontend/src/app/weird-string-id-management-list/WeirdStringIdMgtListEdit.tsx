...
import { WeirdStringIdMgtListManagementPaths } from "./WeirdStringIdMgtListManagement";
...
> {
  ...
  isNewEntity = () => {
    return (
      this.props.entityId === WeirdStringIdMgtListManagementPaths.NEW_SUBPATH
    );
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={WeirdStringIdMgtListManagementPaths.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        ...
        >
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={WeirdStringIdMgtListManagementPaths.PATH}>
