...
import { IntIdManagementCardsPaths } from "./IntIdManagementCards";
...
> {
  ...
  isNewEntity = () => {
    return this.props.entityId === IntIdManagementCardsPaths.NEW_SUBPATH;
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={IntIdManagementCardsPaths.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        ...
        >
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={IntIdManagementCardsPaths.PATH}>
