...
> {
  ...
  isNewEntity = () => {
    return this.props.entityId === CompositionO2OManagementPaths.NEW_SUBPATH;
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={CompositionO2OManagementPaths.PATH} />;
    }
        ...
        >
          ...
          <Field
            ...
            parentEntityInstanceId={
              this.props.entityId !== CompositionO2OManagementPaths.NEW_SUBPATH
                ? this.props.entityId
                : undefined
            }
            formItemProps={{
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={CompositionO2OManagementPaths.PATH}>
