...
import { HooksPOCManagementPaths } from "./HooksPOCManagement";
...
const isNewEntity = (entityId: string) => {
  return entityId === HooksPOCManagementPaths.NEW_SUBPATH;
};
...
const HooksPOCEdit = (props: Props) => {
  ...
  return useObserver(() => {
    if (store.updated) {
      return <Redirect to={HooksPOCManagementPaths.PATH} />;
    }
        ...
        >
          ...
          <Field
            ...
            parentEntityInstanceId={
              entityId !== HooksPOCManagementPaths.NEW_SUBPATH
                ? entityId
                : undefined
            }
            formItemProps={{
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={HooksPOCManagementPaths.PATH}>
