...
import { DatatypesManagement2Paths } from "./DatatypesManagement2";
...
> {
  ...
  isNewEntity = () => {
    return this.props.entityId === DatatypesManagement2Paths.NEW_SUBPATH;
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={DatatypesManagement2Paths.PATH} />;
    }
        ...
        >
          ...
          <Field
            ...
            parentEntityInstanceId={
              this.props.entityId !== DatatypesManagement2Paths.NEW_SUBPATH
                ? this.props.entityId
                : undefined
            }
            formItemProps={{
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={DatatypesManagement2Paths.PATH}>
