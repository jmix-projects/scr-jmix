...
> {
  ...
  isNewEntity = () => {
    return this.props.entityId === CompositionO2MManagementPaths.NEW_SUBPATH;
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={CompositionO2MManagementPaths.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        ...
        >
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={CompositionO2MManagementPaths.PATH}>
