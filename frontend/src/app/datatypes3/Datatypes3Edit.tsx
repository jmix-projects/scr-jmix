...
> {
  ...
  isNewEntity = () => {
    return this.props.entityId === Datatypes3ManagementPaths.NEW_SUBPATH;
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={Datatypes3ManagementPaths.PATH} />;
    }
        ...
        >
          ...
          <Field
            ...
            parentEntityInstanceId={
              this.props.entityId !== Datatypes3ManagementPaths.NEW_SUBPATH
                ? this.props.entityId
                : undefined
            }
            formItemProps={{
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={Datatypes3ManagementPaths.PATH}>
