...
> {
  ...
  isNewEntity = () => {
    return this.props.entityId === AssociationO2MManagementPaths.NEW_SUBPATH;
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={AssociationO2MManagementPaths.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        ...
        >
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={AssociationO2MManagementPaths.PATH}>
